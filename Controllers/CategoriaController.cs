...
namespace PymeCafe.Controllers
{
    public class CategoriaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoriaId,NombreCategoria")] Categoria categorium)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoriaId,NombreCategoria")] Categoria categorium)
        {
