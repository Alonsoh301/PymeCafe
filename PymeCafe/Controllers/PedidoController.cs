...
namespace PymeCafe.Controllers
{
    public class PedidoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PedidoId,UserId,FechaPedido,EstadoPedido,Comentarios")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PedidoId,UserId,FechaPedido,EstadoPedido,Comentarios")] Pedido pedido)
        {
